...
/****** Object:  Table [dbo].[Sys_Shortcuts]    Script Date: 07/22/2016 18:11:29 ******/
...
CREATE TABLE [dbo].[Sys_Shortcuts](
	...
	[ModifyUserName] [varchar](200) NULL,
...
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'用户Id' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'Sys_Shortcuts', @level2type=N'COLUMN',@level2name=N'UserId'
GO
